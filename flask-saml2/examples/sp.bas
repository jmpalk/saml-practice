...
app.config['SERVER_NAME'] = 'WWWXXXYYYZZZ:9001'
app.config['SAML2_SP'] = {
...
app.config['SAML2_IDENTITY_PROVIDERS'] = [
    {
        ...
        'OPTIONS': {
            ...
            'entity_id': 'http://WWWXXXYYYZZZ:8000/saml/metadata.xml',
            'sso_url': 'http://WWWXXXYYYZZZ:8000/saml/login/',
            'slo_url': 'http://WWWXXXYYYZZZ:8000/saml/logout/',
