...
#app.config['SERVER_NAME'] = 'WWWXXXYYYZZZ:8000'
app.config['SERVER_NAME'] = 'WWWXXXYYYZZZ:8000'
...
app.config['SAML2_SERVICE_PROVIDERS'] = [
    {
        ...
        'OPTIONS': {
            ...
            'entity_id': 'http://WWWXXXYYYZZZ:9001/sp1/saml/metadata.xml',
            'acs_url': 'http://WWWXXXYYYZZZ:9001/sp1/saml/acs/',
    ...
    },
    {
        ...
        'OPTIONS': {
            ...
            'entity_id': 'http://WWWXXXYYYZZZ:9000/saml/metadata.xml',
            'acs_url': 'http://WWWXXXYYYZZZ:9000/saml/acs/',
